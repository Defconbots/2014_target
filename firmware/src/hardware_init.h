...
#define HW_INPUT(n)             HW_DIR(n,_INPUT)
#define HW_OUTPUT(n)            HW_DIR(n,_OUTPUT)
...
#define HW_RES(p,i,op)          P##p##REN op _BV(i)
...
#define HW_PULL(n,op)           HW_RES(n,_ENABLE);\
                                HW_SET(n,op)
...
#define HW_INT_ENABLE(n)        HW_INT_EN(n,_ENABLE)
#define HW_INT_DISABLE(n)       HW_INT_EN(n,_DISABLE)
